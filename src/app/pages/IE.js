    ...
    <section className="section">
      <div className="Error container-fluid">
        <div className="header noSelect"><img className="main-logo" src={logo} alt="D V Logo" />
            ...
            <h2 style={{fontSize:'2.2rem'}}>You have landed In a black hole!<div className="breaks">&nbsp;</div> Get back in Orbit with a real Browser:</h2>
            ...
            <h4>Don't miss out. IExplorer is not longer supported by <a className="link" href="https://www.microsoft.com/en-us/microsoft-365/windows/end-of-ie-support">Microsoft</a> </h4>
        </div>
      </div>
    </section>
  ) : <></>;
