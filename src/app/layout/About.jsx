	...
	return (
		<>
			...
			<div className="body-container">
				<p className="p1">If you need a trending app or a new website I can do the job! However, I do more than just web/app development.
					...
					In other words whether as a subcontractor or as in-house developer, I am here to help you or your team to excel in the digital world.</p>
				<br />
